          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              >
                ...
                <Badge
                  variant="secondary"
                  className="ml-1 text-xs bg-amber-100 text-amber-800 hover:bg-amber-100"
                >
                  Save 20%
                </Badge>
              </span>
                ...
                <CardContent className="space-y-4">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Daily Meal
                      Tracking
                    </li>
                    <li className="flex items-center gap-2">
                    ...
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Community
                      Access
                    </li>
                  </ul>
                </CardContent>
              ...
              >
                ...
                <CardContent className="space-y-4">
                  <div className="text-3xl font-bold text-amber-950">
                    ...
                    <span className="text-base font-normal text-amber-900/60">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-center gap-2">
                      ...
                      <span className="text-foreground">Realtime analysis</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-amber-600" />{" "}
                    ...
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-amber-600" />{" "}
                      <span className="text-foreground">Unlimited History</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-amber-600" />{" "}
                  ...
                  <TabsContent value="paypal">
                    <div className="flex flex-col items-center justify-center h-[180px] space-y-3 bg-muted/20 rounded-md border border-dashed">
                      ...
                      <p className="text-sm text-muted-foreground text-center px-4">
                        You will be redirected to PayPal to securely complete
                        your payment.
                      </p>
                    </div>
                  </TabsContent>
